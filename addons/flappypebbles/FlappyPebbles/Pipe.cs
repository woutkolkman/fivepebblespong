...
{
    public class Pipe : FivePebblesPong.FPGameObject
    {
        ...
        public Pipe(OracleBehavior self, FivePebblesPong.FPGame game, Texture2D rect, Texture2D line, Vector2 rectSize, int height = 100, bool reloadImg = false) : base("")
        {
        ...
        public class PipeGraphic : FivePebblesPong.FPGameObject
        {
